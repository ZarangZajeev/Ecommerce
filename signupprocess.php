...
if(mysqli_num_rows($re)>0){
  echo "<script>alert('!!!!!UserName alredy Exist!!!!! Please change your Username');
    ...
    {
      $query = "INSERT into user_tbl VALUES('" . $customer_username . "','" . $customer_name . "','" . $customer_phone . "','" . $customer_email . "','" . $customer_address ."','" . MD5($customer_password) ."','null','user')";
      $success = $con->query($query);
      $query = "INSERT into payment_tbl VALUES('" . $customer_username . "',1000)";
      $success = $con->query($query);
      ...
      if (!$success){
        ...
        echo "<script>alert('sign in agian');
