...
<form action="" method="post" enctype="multipart/form-data">
  <div class="formaction">
    ...
    <b>Name*:</b>
     ...
     <input type="text"  name="name1" value="<?php echo $_POST['update']?>" required><br><br>
       <input type="hidden" class="form-control" id="fdid" name="fdid"  value="<?php echo $_POST['update']?>" required>
